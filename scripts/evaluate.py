...
class BaseEvaluator:
    ...
    def evaluate_with_sampling(self, checkpoint_path: str, config: OmegaConf,
                              ...
                              gibbs: bool = False, csteps: int = 1, cdiv: int = 1,
                              ctype: str = 'sys', thr: float = 0.1, show_progress: bool = False,
                              save_sequences: bool = False) -> Dict[str, Any]:
        """
...
def parse_base_args():
    ...
    parser.add_argument('--gibbs', action='store_true', help='Whether to evaluate Gibbs sampler')
    parser.add_argument('--csteps', type=int, default=1, help='Number of correction steps')
    parser.add_argument('--cdiv', type=int, default=1, help='Size of correction intervals')
    parser.add_argument('--ctype', choices=['random', 'sys'], default='sys', help='Type of Gibbs corrector')
    parser.add_argument('--thr', type=float, default=.1, help='Max token prob to invoke Gibbs corrector')
